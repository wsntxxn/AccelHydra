...
Only ``configs/train.yaml`` is necessary to launch training. You can use the built-in :class:`accel_hydra.TrainLauncher` directly,
...
If your project follows the standard training workflow, you can directly use the built-in :class:`accel_hydra.TrainLauncher`:
...
If you need to customize the training setup (e.g., custom dataloader initialization, custom resolver registration), you can create your own launcher by inheriting from :class:`accel_hydra.TrainLauncher`:
...
The :class:`accel_hydra.TrainLauncher` base class handles:
...
By inheriting from :class:`accel_hydra.TrainLauncher`, you can override specific methods to customize the parts you need.
...
For more details on Hydra syntax and overrides, see the :doc:`Configuration Guide <config_guide>`.

Next Steps
-----------

- Learn about :doc:`Trainer hooks and customization <trainer>`
- Understand :doc:`Hydra configuration patterns <config_guide>`
- Explore :doc:`helper functions and utilities <api/index>`
